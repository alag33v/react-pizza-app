...
const Cart = () => {
  ...
  const onMinusCartPizza = pizzaId => {
    dispatch(minusCartPizza(pizzaId));
  };

  const onPlusCartPizza = pizzaId => {
    dispatch(plusCartPizza(pizzaId));
  };

  const onRemovePizza = pizzaId => {
    console.log(pizzaId);
    dispatch(removeCartPizza(pizzaId));
  };
            ...
            {pizzasItems.map(pizza => {
              return (
                <CartItem
                  ...
                  dough={pizza.dough}
                  size={pizza.size}
                  itemsCount={pizzas[pizza.id].pizzas.length}
                  totalPrice={pizzas[pizza.id].totalPrice}
                  onMinusCartPizza={onMinusCartPizza}
                  onPlusCartPizza={onPlusCartPizza}
